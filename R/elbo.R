...
elbo_lambda_ <- function(a_inv_vb, log_a_inv_vb, log_lambda_inv2_vb, eta_lambda, lambda_inv2_vb, d) {
  ...
  # elbo_lambda <- 1/2 * (- d*log_lambda_inv2_vb + log_a_inv_vb - (d+1)*log(eta_lambda) + (eta_lambda - a_inv_vb)*lambda_inv2_vb) # Functional version
...
elbo_tau_ <- function(b_inv_vb, log_b_inv_vb, log_tau_inv2_vb, eta_tau, tau_inv2_vb, p) {
  ...
  # elbo_tau <- 1/2 * (- p*log_tau_inv2_vb + log_b_inv_vb - (p+1)*log(eta_tau) + (eta_tau - b_inv_vb)*tau_inv2_vb) # Functional version
